...
$$ |      $$  /\$$\    $$ |  $$\ $$ |  $$ |$$ |  $$ |  $$ |  $$ |\$$$ |$$ |  $$ |
$$$$$$$$\ $$ /  $$ |$$\\$$$$$$  | $$$$$$  |$$$$$$$  |$$$$$$\ $$ | \$$ |\$$$$$$  |
\________|\__|  \__|\__|\______/  \______/ \_______/ \______|\__|  \__| \______/
...
def biodata () :
		...
		print "\033[1;92m========================================================"
		print "\033[1;91m*KETIKAN DENGAN HURUF KAPITAL SAJA YEKAN!"
...
def spamsms():
	...
	system('pkg install git')
	system('pkg install php')
	system('git clone https://github.com/lxcoding666/SpamSms')
...
def keluar():
	print "\033[1;93mTERIMA KASIH TELAH GABUT BERSAMA:)"
	print
	sys.exit()
...
time.sleep(0.5)
print "\033[1;92m------------------------------------------"
print "SELAMAT DATANG DI PROGRAM GABUT YEKAN"
print "------------------------------------------"
pilihan = 'y'
while (pilihan != 't'):
	menu()
	...
	if pilih == 1:
			...
			keluar()
        	        ...
        	        print ("\033[91mTINGGAL PILIH AJA SUSAH AMAT BABYI -_-")
			print
